package com.example.projecto_suarez.presentation.map.components
...
@Composable
fun CanvasMap(onTouchPaint: (String) -> Unit) {
    ...
    Column {
        BoxWithConstraints {
            ...
            picture(1, maxWidth*.1f, maxHeight*.1f, maxWidth, maxHeight, onTouchPaint)
            picture(2, maxWidth*.3f, maxHeight*.1f, maxWidth, maxHeight, onTouchPaint)
            picture(3, maxWidth*.6f, maxHeight*.1f, maxWidth, maxHeight, onTouchPaint)
            picture(4, maxWidth*.8f, maxHeight*.1f, maxWidth, maxHeight, onTouchPaint)
        }
...
@Composable
fun picture(ID: Int, x: Dp, y: Dp, w: Dp, h: Dp, onTouchPaint: (String) -> Unit) {
    Canvas(
        modifier = Modifier
            .size(w*.1f)
            .offset(x, y)
